...
TTFLoader::TTFLoader(const Common::String &fileName, const Common::String &faceName, bool bold, int32 faceIndex) :
	TTFLoader(fileName, faceName, Common::String(), bold, faceIndex) {
}
...
Common::String TTFLoader::getCacheName(int point) const {
	return Common::String::format("%s@%d", _faceName.c_str(), point);
}
...
FileTTFLoader::FileTTFLoader(const Common::String &fileName, const Common::String &faceName, bool bold, int32 faceIndex) :
	TTFLoader(fileName, faceName, Common::String(), bold, faceIndex) {
}

FileTTFLoader::FileTTFLoader(const Common::String &fileName, const Common::String &faceName, const Common::String &srcInst, bool bold, int32 faceIndex) :
...
const Graphics::Font *FileTTFLoader::loadFontCore(int point) {
	...
	font = Graphics::findTTFace(files, fontFace, true, false, pointSize, 0, 0, Graphics::kTTFRenderModeMonochrome);
#else
	Common::SeekableReadStream* stream = getStream();
	if (stream) {
		font = Graphics::loadTTFFont(stream, DisposeAfterUse::YES, point,
			Graphics::kTTFSizeModeCharacter, 0, 0, Graphics::kTTFRenderModeMonochrome, 0, false,
...
ISCabTTFLoader::ISCabTTFLoader(const Common::String &iscabFile, const Common::String &fileName, const Common::String &faceName, bool bold, int32 faceIndex) :
	ISCabTTFLoader(iscabFile, fileName, faceName, Common::String(), bold, faceIndex) {
}
...
ISZTTFLoader::ISZTTFLoader(const Common::String &iszFile, const Common::String &fileName, const Common::String &faceName, bool bold, int32 faceIndex) :
	ISZTTFLoader(iszFile, fileName, faceName, Common::String(), bold, faceIndex) {
}
...
WinSysTTFLoader::WinSysTTFLoader(const Common::String &fileName, const Common::String &faceName, bool bold, int32 faceIndex) : 
	FileTTFLoader(fileName, faceName, bold, faceIndex) {
}

WinSysTTFLoader::WinSysTTFLoader(const Common::String &fileName, const Common::String &faceName, const Common::String &srcInst, bool bold, int32 faceIndex) :
	FileTTFLoader(fileName, faceName, srcInst, bold, faceIndex) {
}
...
ArchiveTTFLoader::ArchiveTTFLoader(const Common::String &fileName, const Common::String &faceName, bool bold, int32 faceIndex) :
	TTFLoader(fileName, faceName, Common::String(), bold, faceIndex) {
}

ArchiveTTFLoader::ArchiveTTFLoader(const Common::String &fileName, const Common::String &faceName, const Common::String &srcInst, bool bold, int32 faceIndex) :
	TTFLoader(fileName, faceName, srcInst, bold, faceIndex) {
}
...
const Graphics::Font *ArchiveTTFLoader::loadFontCore(int point) {
	...
	font = Graphics::loadTTFFontFromArchive(_filePath.baseName(), point,
		Graphics::kTTFSizeModeCharacter, 0, 0, Graphics::kTTFRenderModeMonochrome);
#endif
	return font;
}

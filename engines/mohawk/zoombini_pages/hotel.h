...
private:
	...
	/** Cheer animation completed. IDA: word_4AB778 */
	bool _bCheerAnimDone = false;
	/** Win animation completed. IDA: word_4AB77E */
	...
	// Counter / reset
	// -----------------------------------------------------------------------
	/** Out-of-steps: too many rejections, board resets. IDA: word_4AB7C4 */
	bool _bOutOfSteps = false;
	...
	/** Guide state (0=not loaded). IDA: word_4AB746 */
	int16 _guideState = 0;
	/** Guide animation has finished. IDA: word_4AB748 */
	bool _guideComplete = false;
